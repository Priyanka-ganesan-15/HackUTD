...
import openai
OPENKEY = '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'
# OpenAI API Key
openai.api_key = OPENKEY  # Replace with your OpenAI API key

st.title("Chat with a topic-expert AI!")
